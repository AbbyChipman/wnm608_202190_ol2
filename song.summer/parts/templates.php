...
return $r.<<<HTML
<a class="col-xs-12 col-md-4 card soft" href="active_wear_item.php?id=$o->id">
...
<div class="flex-stretch cart_title"">
    <strong>$o->name ($o->amount)</strong>
    <form action="cart_actions.pnp?action=delete-cart-item" method="post">
    ...
    <div class="flex-none >
        ...
        <form action="cart_actions.pnp?action=update-cart-item" method="post" onchange="this.submit()">
